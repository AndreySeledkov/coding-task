package pl.beutysite.recruit.util;
...
public class TaxCalculationsHelper {
    ...
    private final static BigDecimal PERCENT_100 = new BigDecimal(100);
    ...
    public static BigDecimal getPercentagePart(BigDecimal base, BigDecimal percentage) {
        return percentage.divide(PERCENT_100, mathContext).multiply(base, mathContext);
    }
